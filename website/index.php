...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        ...
        <main>
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">👋 Welcome to DUCKTOR</h1>
                        <p class="hero-paragraph is-revealing">Welcome to your dedicated space for medical excellence! Explore, learn, and thrive on our tailored platform designed exclusively for medical students. Your journey to mastery begins here.</p>
                        <div class="hero-form newsletter-form field field-grouped is-revealing">
                            <div class="control" style="margin-left: 7em;">
                                <a class="button button-primary button-block button-shadow" href="dash.php">Try the early access</a>
                            </div>
                        </div>
                        <div class="hero-browser">
                            ...
                            <div class="hero-browser-inner is-revealing">
                                <img style="border-radius: 1em;" src="dist/css/med.jpg" alt="Description of the image" width="800" height="450">
                        ...
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Instant answers, no hand raising. Our Chatbot enhances your learning experience.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title">Live Lecture</h3>
                                    <p class="text-sm">Automatically record, transcribe, and ask questions in real-time. Elevate your learning with Live Lecture. <br> (under construction)</p>
                                </div>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Optimize medical studies with our Computer Vision feature. Effortlessly interpret complex medical images for an enhanced learning experience.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm"> Effortless quizzes tailored to your studies. Boost knowledge retention quickly. <br> (under construction) </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center is-revealing">
                            <h2 class="section-title mt-0"> 🌶️ Meet the HarissAI team </h2>
                            <p class="section-paragraph">We are an AI engineering student and entreprise systems engineering student committed to innovative solutions at the crossroads of technology and education.</p>
                            <div class="hero-browser-inner is-revealing">
                                <img style="border-radius: 1em;" src="dist/css/rm.jpg" alt="photo of the team members" width="800" height="450">
                            ...
                            <div class="features-wrap">
                                <div class="feature is-revealing">
                                    <div class="feature-inner">
                                        ...
                                        <h3 class="feature-title">Ramy Aouinet</h3>
                                        <p class="text-sm">Our AI Engineering Specialist, is a dedicated student in AI Engineering at ESPRIT. With a sharp focus on the technical intricacies of artificial intelligence, Ramy plays a pivotal role in shaping the innovative solutions that define HarissAI. His expertise ensures the seamless integration of advanced AI technologies into our project.</p>
                                    </div>
                                </div>
                                <div class="feature is-revealing">
                                    <div class="feature-inner">
                                        
                                        <h3 class="feature-title">Mariem El Goumi</h3>
                                        <p class="text-sm">our diligent Enterprise Systems Engineering student, brings her expertise to HarissAI. Focused on the intersection of enterprise systems and cutting-edge technology, Mariem contributes crucial insights. Her dedication ensures the effective integration of innovative solutions into our projects.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="features section" style="margin-top: -9%; padding-bottom: 10%;">
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center is-revealing">
                            <h2 class="section-title mt-0">📧 Stay in the know</h2>
                            <p class="section-paragraph">Stay informed, stay ahead. Discover the latest updates, insights, and breakthroughs in the dynamic world of medicine. Your knowledge hub awaits.</p>
                        </div>
